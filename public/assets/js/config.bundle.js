...
// ----------------------------------------------------- object
var products = new _modules_DB_products__WEBPACK_IMPORTED_MODULE_2__["default"](userId, username);
...
;
function sendDataToPHP(_x2) {
  return _sendDataToPHP.apply(this, arguments);
} // ----------------------------------------------------- Get Produtos
function _sendDataToPHP() {
  _sendDataToPHP = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(jsonData) {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function createProductList(_x3) {
  return _createProductList.apply(this, arguments);
}
function _createProductList() {
  _createProductList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(responseData) {
    var itemList, _i2, _Object$entries, _Object$entries$_i, id, dado, item, liElement;
...
function _showMyProducts() {
  _showMyProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var responseData;
...
function _showMyPurchases() {
  _showMyPurchases = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var responseData;
...
function _updateProductList() {
  _updateProductList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var responseData;
...
function maskCpf(cpf) {
  ...
  var maskedDigits = '*'.repeat(2);
  return "".concat(visibleDigits).concat(maskedDigits);
}
