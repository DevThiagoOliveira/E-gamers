...
// validação
var formValidation = new _modules_loginRegister_validarFormulario__WEBPACK_IMPORTED_MODULE_2__.ValidarFormulario(formulario);
console.log(formulario);

// conexão com Banco de dados | PHP
formulario.addEventListener('submit', function (element) {
  element.preventDefault();
  var formData = new FormData(_this); // envia todos os parametros do formulario
