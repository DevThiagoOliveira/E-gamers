...
var productSearch = /*#__PURE__*/function () {
  ...
  _createClass(productSearch, [{
    key: "product",
    value: function () {
      var _product = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var url,
          data,
          response,
          responseData,
...
var User = /*#__PURE__*/function () {
  ...
  _createClass(User, [{
    key: "userData",
    value: function () {
      var _userData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var userId, username, data, response, responseData;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              userId = parseInt(sessionStorage.getItem('id_usuario'));
        ...
        usuarios.forEach(function (element) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              if (index.login === _this2.username.value.toLowerCase() && index.senha === _this2.password.value.toLowerCase()) {
...
/***/ "./src/modules/ferramentas/layoutItem.js":
/*!***********************************************!*\
  !*** ./src/modules/ferramentas/layoutItem.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var layoutItem = /*#__PURE__*/function () {
  function layoutItem(name, image) {
  ...
  _createClass(layoutItem, [{
    ...
    value: function createLi() {
      ...
      var span = this.createSpan();
      var buttonEdit = this.buttonEdit();
    ...
    value: function createImg() {
      ...
      var imagePath = "../../src/assets/img/product/".concat(this.image);
...
function _importModules() {
  _importModules = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var navBarConfigsModule, navBar, username, status, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return __webpack_require__.e(/*! import() */ "src_modules_ferramentas_navBarConfig_js").then(__webpack_require__.bind(__webpack_require__, /*! ../ferramentas/navBarConfig.js */ "./src/modules/ferramentas/navBarConfig.js"));
        case 2:
          navBarConfigsModule = _context.sent;
          navBar = document.querySelector('.nav-content');
          username = sessionStorage.getItem('username');
          status = sessionStorage.getItem('status');
          user = new navBarConfigsModule["default"](navBar, username, status);
        case 7:
        case "end":
          return _context.stop();
      }
...
/* harmony import */ var _modules_DB_products__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/DB/products */ "./src/modules/DB/products.js");
/* harmony import */ var _modules_ferramentas_layoutItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/ferramentas/layoutItem */ "./src/modules/ferramentas/layoutItem.js");
...
/* harmony import */ var _modules_DB_users__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../modules/DB/users */ "./src/modules/DB/users.js");
...
function _addProduct() {
  _addProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var formData, jsonData, description, _iterator, _step, _step$value, name, value, fileReader;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          formData = new FormData(productForm);
          jsonData = {};
          description = quill.root.innerHTML; // Obtém o conteúdo do editor Quill
          ...
          if (formData.get("image") instanceof File) {
            ...
            fileReader.onload = function (event) {
              ...
              var send = sendDataToPHP(jsonData);
            };
...
function _sendDataToPHP() {
  _sendDataToPHP = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(jsonData) {
    var response, data;
...
function createProductList(_x2) {
  return _createProductList.apply(this, arguments);
}
function _createProductList() {
  _createProductList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(responseData) {
    var itemList, _i2, _Object$entries, _Object$entries$_i, id, dado, productId, item, liElement;
...
function showMyProducts() {
  return _showMyProducts.apply(this, arguments);
}
function _showMyProducts() {
  _showMyProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var responseData;
...
function showMyPurchases() {
  return _showMyPurchases.apply(this, arguments);
}
function _showMyPurchases() {
  _showMyPurchases = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var responseData;
...
function _updateProductList() {
  _updateProductList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var responseData;
...
function openEditPopup(productId) {
  ...
  getProductDetails(productId).then(function (productDetails) {
...
function getProductDetails(_x4) {
...
function _getProductDetails() {
  _getProductDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(productId) {
...
function updateProductDetails(_x5) {
  return _updateProductDetails.apply(this, arguments);
} // Função para deletar um produto
function _updateProductDetails() {
  _updateProductDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(updatedProduct) {
    var response;
...
try {
  var userResponseData = userObject.userData();
